...
namespace CCGKit
{
    ...
    /// </summary>
    public abstract class IntegerRangeEffect : TargetableEffect
    {
        public int LowValue;
        ...
        public override void Draw(Rect rect)
        {
            ...
            LowValue = EditorGUI.IntField(rect, "Low Value", LowValue, numberFieldStyle);
            
            rect.y += RowHeight;
            HighValue = EditorGUI.IntField(rect, "High Value", HighValue, numberFieldStyle);
        }
